...
void voting()
{
    ...
    printf("\t\t\t 3.KCR                            3.Car\n");
    Sleep(300);
    printf("\t\t\t 4.Aravind Kejriwal               4.Broomstick\n");
    Sleep(300);
    printf("\t\t\t 5.Mamata Banerjee                5.Fish\n\n\n");
       ...
       for(j=1;j<=1;j++)
       {
           ...
           {
               vote3++;
                printf("\n\n\t\t\t\tYOU HAVE SUCCESSFULLY GIVEN YOUR VOTE TO KCR\n");
               break;
           ...
           {
               vote5++;
                printf("\n\n\t\t\t\tYOU HAVE SUCCESSFULLY GIVEN YOUR VOTE TO MAMAMATA BANERJEE\n");
               break;
           }
  ...
  void show()
  {
   ...
   void winner()
   {
       ...
       if(vote1<vote2 && vote3< vote2 && vote4<vote2 && vote5<vote2)
        ...
        printf("\t\t\tThe present Winner is KCR and He has got %d votes\n\n\n\n",vote3);

        if(vote1<vote4 && vote2< vote4 && vote3<vote4 && vote5<vote4)
        printf("\t\t\tThe present Winner is Arvind Kejriwaland He has got %d votes\n\n\n\n",vote4);
